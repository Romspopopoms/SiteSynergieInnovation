    ...
    return (
        <div className="md:grid md:grid-cols-2 flex flex-col items-end mt-32 bg-cover min-h-[600px]" style={{ backgroundImage: `url(${BGLanding})` }}>
            ...
            <p className="text-white text-lg sm:text-2xl font-afacad mx-auto text-start mt-6 md:mt-12">
                Prenez les devants et lancez votre projet avec Synergie Innovation. Ensemble, nous concevrons un site internet, un design, et un plan de communication personnalisés qui sauront captiver votre audience et propulser votre entreprise vers de nouveaux horizons.
            </p>
