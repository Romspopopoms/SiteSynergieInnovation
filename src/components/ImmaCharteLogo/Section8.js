    ...
    return (
        <div className="flex flex-col justify-center items-center w-full px-4 md:px-0 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-6xl mx-auto mt-8">
                ...
                <div className="flex flex-col justify-center items-center text-center md:text-left md:min-h-[300px]">
                    <h2 className="font-DmSerif font-bold text-2xl md:text-4xl text-[#474747] mb-4">Le branding ?</h2>
                ...
                <div className="flex flex-col justify-center items-center text-center md:text-left md:min-h-[300px]">
                    <h2 className="font-DmSerif font-bold text-2xl md:text-4xl text-[#474747] mb-4">Les supports</h2>
                    <p className="font-DmSerif text-[#474747] text-sm md:text-base max-w-[90%] md:max-w-[400px]">
