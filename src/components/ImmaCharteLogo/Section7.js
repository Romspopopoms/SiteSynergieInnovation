...
const Section7 = () => {
    return (
        <div className="flex flex-col justify-center items-center w-full mx-auto px-4 md:px-0 max-w-[70%]">

            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full mx-auto mt-6">
                ...
                <div className="flex flex-col justify-start items-center mb-6">
                    ...
                    <div className="relative w-full max-w-[450px] h-[220px] md:h-[280px] flex justify-center items-center text-[#474747] text-4xl p-4 overflow-hidden">
                        <img src={BG1} alt="Élément Visuel" className="w-full h-full object-cover absolute z-0 "/>
                    </div>

                    {/* Titre et texte sous le bloc visuel */}
                    <div className="text-center md:text-left max-w-[90%] md:max-w-[400px] mr-12 md:mt-6 sm:mt-12">
                ...
                <div className="flex flex-col justify-start items-center">
                    {/* Élément graphique : Image */}
                    <div className="relative w-full max-w-[450px] h-[220px] md:h-[280px] flex justify-center items-center text-white text-4xl p-4 overflow-hidden">
                    ...
                    {/* Titre et texte sous le bloc visuel */}
                    <div className="text-center md:text-left max-w-[90%] md:max-w-[400px] mt-6 mr-12">
