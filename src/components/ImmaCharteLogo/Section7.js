...
const Section7 = () => {
    return (
        <div className="flex flex-col justify-center items-center w-full px-4 md:px-0">
            <h1 className="font-poppins font-bold text-2xl md:text-4xl text-[#474747] text-center mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-6xl mx-auto mt-12">
                ...
                <div className="flex flex-col justify-center items-center">
                    ...
                    <div className="relative w-full max-w-[400px] h-[220px] md:h-[280px] rounded-[20px] flex justify-center items-center text-[#474747] text-4xl p-4 overflow-hidden">
                    ...
                    <div className="text-center md:text-left max-w-[90%] md:max-w-[400px] mt-6">
                        <h2 className="font-poppins font-bold text-2xl md:text-4xl text-[#474747] mb-4">Éléments Visuels Supplémentaires</h2>
                ...
                <div className="flex flex-col justify-center items-center">
                    ...
                    {/* Titre et texte sous le bloc visuel */}
                    <div className="text-center md:text-left max-w-[90%] md:max-w-[400px] mt-6">
                        <h2 className="font-poppins font-bold text-2xl md:text-4xl text-[#474747] mb-4">Consignes d'Utilisation</h2>
                        <p className="font-poppins text-[#474747] text-sm md:text-base">
