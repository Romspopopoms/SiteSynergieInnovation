...
return (
    <div className="flex flex-col justify-center items-center w-full px-4 md:px-0">
        <h1 className="font-dmserif font-medium text-2xl md:text-6xl text-[#474747] text-center mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 space-y-16 md:space-y-0 w-full max-w-6xl mx-auto md:mt-12">
            ...
            <div className="flex flex-col justify-start items-center col-span-3">
                ...
                <div className="bg-[#FFFFFF] p-8 rounded-[20px] shadow-lg w-full md:h-[320px] flex justify-around items-center max-w-[90%] md:max-w-[700px] space-x-4 text-[#474747] text-5xl">
                    <FaHome />
                    <FaGlobe />
                    <FaWrench />
                    <FaLink />
            ...
            <div className="flex flex-col justify-center items-center col-span-2">
                ...
                <div className="w-full max-w-[90%] md:max-w-[320px] h-[320px] rounded-[20px] overflow-hidden">
                    <img 
                        src={Eveque} 
                        alt="Feu" 
