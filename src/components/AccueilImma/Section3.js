    ...
    return (
        <div className="flex flex-col bg-[#FFFBED] w-full py-16">
            <div className="text-center mb-12">
                <h2 className="text-6xl font-DmSerif font-regular text-[#474747] max-w-[80%] mx-auto">Développez votre image</h2>
            </div>
            <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-8 w-full px-8">
                
                {/* Card 1 */}
                <div className="relative shadow-lg w-full md:w-1/3 max-w-[350px] min-h-[350px] flex flex-col justify-between p-6">
                    ...
                    <div className="relative flex flex-col h-full">
                        <div className="text-left">
                            ...
                            <p className="text-sm font-light text-[#474747] italic mb-4">À votre image</p>
                        </div>
                        <div className="text-left flex-grow">
                            <p className="text-md font-jost text-[#474747] mb-8">
                        ...
                        <a href='/ImmaMissioCharteGraphique'className="mt-6">
                            <button className="border border-black px-4 py-2 font-jost">En savoir plus</button>
                        </a>
                    </div>
                </div>
                ...
                <div className="relative shadow-lg w-full md:w-1/3 max-w-[350px] min-h-[350px] flex flex-col justify-between p-6">
                    ...
                    <div className="relative flex flex-col h-full">
                        <div className="text-left">
                            ...
                            <p className="text-sm font-light text-[#474747] italic mb-4">Authentique</p>
                        </div>
                        <div className="text-left flex-grow">
                            <p className="text-md font-jost text-[#474747] mb-8">
                        ...
                        <a href='/ImmaMissioCharteGraphique' className="mt-auto">
                            <button className="border border-black px-4 py-2 font-jost">En savoir plus</button>
                        </a>
                    </div>
                </div>
                ...
                <div className="relative shadow-lg w-full md:w-1/3 max-w-[350px] min-h-[350px] flex flex-col justify-between p-6">
                    ...
                    <div className="relative flex flex-col h-full">
                        <div className="text-left">
                            ...
                            <p className="text-sm font-light text-[#474747] italic mb-4">Personnalisé</p>
                        </div>
                        <div className="text-left flex-grow">
                            <p className="text-md font-jost text-[#474747] mb-8">
                        ...
                        <a href='/ImmaMissioWebDesign' className="mt-auto">
                            <button className="border border-black px-4 py-2 font-jost">En savoir plus</button>
                        </a>
                    </div>
                </div>
