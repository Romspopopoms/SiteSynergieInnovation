...
const Section2 = () => {
    return (
        <div className="flex flex-col bg-[#FFFBED] w-full relative">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 w-full max-w-[90%] sm:max-w-[80%] md:max-w-[70%] lg:max-w-[60%] bg-white shadow-lg p-6 sm:p-8 md:p-10 text-center">
                <h1 className="text-2xl sm:text-3xl md:text-5xl text-[#474747] font-DmSerif font-medium">
                    Connaitre les besoins pour mieux y répondre
                </h1>
                <p className="text-xl sm:text-2xl md:text-3xl font-jost font-medium text-[#474747] mt-6 sm:mt-8 md:mt-12">
