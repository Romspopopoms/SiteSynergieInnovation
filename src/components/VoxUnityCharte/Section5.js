...
const Section5 = () => {
    return (
        <div className="flex flex-col justify-center items-center w-full px-4 md:px-0">
            ...
            <div className="w-full max-w-5xl mx-auto">
                ...
                <div className="w-full mb-8">
                    <img 
                        ...
                        className="w-full h-auto rounded-xl shadow-lg object-cover max-h-[770px]" 
                    />
                </div>
            ...
            {/* Bloc contenant les textes */}
<div className="grid grid-cols-1 md:grid-cols-2 w-full max-w-6xl  mt-8">
    {/* Colonne de gauche : Texte sur le branding */}
    <div className="flex flex-col justify-start items-start text-center md:text-left md:ml-16">
        <h2 className="font-poppins font-bold text-2xl md:text-4xl text-white mb-4">Le branding ?</h2>
        <p className="font-poppins text-left  text-[#FFFFFF] text-sm md:text-base max-w-[90%] md:max-w-[400px] mb-8">
    ...
    <div className="flex flex-col justify-start items-start text-center md:text-left md:ml-2">
        <h2 className="font-poppins font-bold text-2xl md:text-4xl text-white mb-4">Les supports</h2>
        <p className="font-poppins text-[#FFFFFF] text-left text-sm md:text-base max-w-[90%] md:max-w-[400px]">
