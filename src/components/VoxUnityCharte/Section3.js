        ...
        <div className="flex flex-col justify-center items-center w-full px-4 md:px-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 space-y-16 md:space-y-0 w-full max-w-6xl mx-auto mt-12">
                ...
                <div className="flex flex-col justify-start items-center col-span-3">
                    ...
                    <div className="bg-[#071726] p-8 rounded-[20px] shadow-lg w-full h-[320px] flex justify-around items-center max-w-[90%] md:max-w-[700px] space-x-4 text-white text-5xl">
                        <FaHome />
                        <FaGlobe />
                        <FaWrench />
                        <FaLink />
                    ...
                    <div className="text-center md:text-left w-full max-w-[90%] md:max-w-[700px] mt-6">
                        <h2 className="font-poppins font-bold text-2xl md:text-4xl text-white mb-4">Iconographie</h2>
                ...
                <div className="flex flex-col justify-center items-center col-span-2">
                    ...
                    <div className="text-center md:text-left max-w-[90%] md:max-w-[320px] mt-6">
                        <h2 className="font-poppins font-bold text-2xl md:text-4xl text-white mb-4">Photo et illustration</h2>
                        <p className="font-poppins text-[#FFFFFF] text-sm md:text-base">
