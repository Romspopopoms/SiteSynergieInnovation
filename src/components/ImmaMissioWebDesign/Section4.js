...
const Section4 = () => {
    return (
        <div className="flex flex-col justify-center items-center w-full px-4 md:px-0 ">
            {/* Titre principal */}
            <h1 className="font-poppins font-bold text-4xl md:text-6xl text-center text-[#474747] mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16 w-full max-w-6xl">
                ...
                {features.slice(0, 3).map((feature, index) => (
                    <div key={index} className="flex flex-col items-center space-y-8">
                        <div className="bg-white shadow-2xl bg-opacity-40 w-48 h-48 flex justify-center items-center rounded-lg">
                        ...
                        <div className="flex flex-col justify-items-center md:justify-start md:items-start w-full max-w-full md:max-w-[67%]">
                            <h3 className="font-poppins font-semibold text-xl text-[#474747] text-center md:text-left">
                                {feature.title}
                            </h3>
                            <p className="font-poppins text-sm text-[#474747] mt-2 text-center md:text-left">
                                {feature.description}
                            </p>
                        </div>
                    </div>
            ...
            <div className="w-full mt-16 flex flex-col items-center">
                ...
                <div className="flex items-center justify-center bg-white shadow-2xl bg-opacity-40 w-[90%] md:w-[80%] h-40 rounded-lg mb-6">
                    <div className="text-[#474747] text-5xl">
                        <FaLayerGroup />
                    </div>
                </div>
                ...
                <div className="w-[90%] md:w-[80%] max-w-5xl mb-12">
                    <h2 className="font-poppins font-bold text-2xl md:text-4xl text-[#474747] text-center md:text-left mb-4">
                        Design Minimaliste
                    </h2>
                    <p className="font-poppins text-[#474747] text-center md:text-left text-lg md:text-xl leading-relaxed">
