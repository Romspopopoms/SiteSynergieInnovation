...
const Section4 = () => {
    ...
    <div className="flex flex-col justify-center items-center px-4 md:px-0">
        <h1 className="font-poppins font-bold text-4xl md:text-6xl text-center text-[#474747]">Quelques exemples</h1>
        ...
        <div className="flex flex-col justify-center items-center max-w-[90%] space-y-12 mt-12 mb-12" >
            ...
            <h2 className="font-poppins font-bold text-xl md:text-2xl text-[#474747] w-full mb-2">Modèle VoxUnity</h2>
            <div className="flex w-full justify-end items-center space-x-2">
            <p className="text-[#474747]">Découvrir</p>
            <FaArrowRight className="text-[#474747] "/>
            </div>
            </a>

            <img src={Site2} alt="Site1" className="w-full object-cover" style={{borderRadius: '35px'}}></img>
            <a href="/VoxUnity" target="blank" className="flex w-full justify-between items-center">
            <h2 className="font-poppins font-bold text-xl md:text-2xl text-[#474747] w-full mb-2">Modèle Saint Athanase</h2>
            <div className="flex w-full justify-end items-center space-x-2">
            <p className="text-[#474747]">Découvrir</p>
            <FaArrowRight className="text-[#474747] "/>
            </div>
            ...
            <a href="/VoxUnity" target="blank" className="flex w-full justify-between items-center">
            <h2 className="font-poppins font-bold text-xl md:text-2xl text-[#474747] w-full mb-2">Modèle Pain</h2>
            <div className="flex w-full justify-end items-center space-x-2">
            <p className="text-[#474747]">Découvrir</p>
            <FaArrowRight className="text-[#474747] "/>
            </div>
