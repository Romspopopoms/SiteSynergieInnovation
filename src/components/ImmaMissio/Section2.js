  ...
  return (
    <section className="relative w-full">
      ...
      >
        ...
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white bg-opacity-90 shadow-lg p-4 md:p-8 mb-12 min-w-[90%] lg:min-w-[55%] md:max-w-[80%] lg:max-w-[50%] z-20 min-h-[320px] md:min-h-[370px]">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium text-center text-[#474747] mb-4 md:mb-8">
            Nos compétences au service de l'Eglise
          </h2>
          <p className="text-[#474747] text-center text-base sm:text-lg md:text-xl leading-relaxed max-w-[90%] md:max-w-[70%] mx-auto">
        ...
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 bg-white bg-opacity-90 shadow-lg p-4 md:p-8 min-w-[90%] lg:min-w-[55%] md:max-w-[80%] lg:max-w-[60%] z-20 min-h-[320px] md:min-h-[370px]">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium text-center text-[#474747] mb-4 md:mb-8">
