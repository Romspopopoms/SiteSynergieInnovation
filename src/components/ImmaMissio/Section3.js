  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-8 md:p-16 lg:p-24 text-center ">
        <h2 className="text-3xl md:text-5xl font-medium font-dmserif text-[#FFFDF5] mb-6">
          Une équipe de missionnaires 2.0
        </h2>
        <p className="text-lg md:text-xl text-[#FFFDF5] leading-relaxed md:max-w-[60%] font-jost mx-auto">
