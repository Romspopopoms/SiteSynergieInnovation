...
const Section2 = () => {
    ...
    return (
        <div className=" grid grid-cols-1 relative mt-36 md:max-w-[80%] mx-auto">
            <div className="mt-8 flex flex-col py-8 px-8 space-y-8 items-center">
                <h2 className="font-inter text-[#FFFFFF] font-bold text-4xl md:text-7xl text-center md:mb-12">Des question?</h2>
                <div className="flex flex-col gap-4 items-start w-full">
                        ...
                        {Open && (
                            <div className="mt-4 ml-20 max-w-[80%]">
                                <p className="text-left font-afacad text-xl text-[#FFFFFF]">
                                    Nous proposons des solitions personnalisées incluant la création de site web vitrine, e-commerce, CRM, ainsi que de services de design graphique, de SEO, et de développement d'applications web.
                                </p>
                            </div>
                        )}
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        {Open2 && (
                            <div className="mt-4 ml-20 max-w-[80%] text-[#394040]">
                                <p className="text-left font-afacad text-xl text-[#FFFFFF]">
                                    Nos tarifs sont compétitifs et adaptés aux besoins sépcifiques de chaque client. Contactez-nous pour obtenir un devis personnalisé en fonction de votre projet.
                                </p>
                            </div>
                        )}
                        <hr className="border-0 h-px bg-gradient-to-r from-transparent via-white to-transparent my-0 mt-8" />
                    ...
                    <div className="flex flex-col w-full z-10 relative">
                        ...
                        {Open3 && (
                            <div className="mt-4 ml-20 max-w-[80%]">
                                <p className="text-left font-afacad text-xl text-[#FFFFFF]">
                                    Nous offrons des services de SEO pour améliorer le classement de votre site sur les moteurs de recherche et augmenter sa visibilité en ligne. Nous adaptions nos stratégies pour maximiser votre présence digitale.
                                </p>
