    ...
    return (
        <div className="flex flex-col justify-center items-center w-full px-4 md:px-0 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16 w-full max-w-[70%]">
                ...
                {features.slice(0, 3).map((feature, index) => (
                    <div key={index} className="flex flex-col items-center space-y-8">
                        <div className="bg-[#071726] bg-opacity-40 shadow-lg w-60 h-60 flex justify-center items-center rounded-xl">
            ...
            <div className="w-full mt-16 flex flex-col items-center">
                ...
                <div className="flex items-center justify-center bg-[#071726] bg-opacity-40 w-[90%] md:w-[70%] h-40 rounded-xl mb-6">
                ...
                <div className="w-[90%] md:w-[70%] max-w-5xl mb-12">
