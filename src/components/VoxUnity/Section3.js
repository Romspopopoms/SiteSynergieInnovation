...
const Section3 = () => {
    return (
        <div className="flex justify-center items-center w-full px-8 md:px-0 ">
            ...
            <div className="md:max-w-[30%] flex max-auto">
            ...
            style={{borderRadius: '32px'}}></img>
                <h1 className="font-poppins font-bold text-4xl md:text-2xl text-white text-end mb-4">Booster votre communication</h1>
               <p className="font-poppins text-[#FFFFFF]  font-medium text-end"
            ...
            <a href="/Communication" className="bg-white px-8 py-3 rounded-full self-center">
