...
const Section4 = () => {
    return (
        ...
        <div className="flex flex-col justify-center items-center w-full h-auto  space-y-12">
            ...
            <img src={Feu} alt="Artifice" className="object-cover md:max-w-[90%] lg:max-w-[80%] xl:max-w-[60%]"
            ...
            <a href="/VoxUnityCharteGraphique" className="bg-white px-8 py-2 rounded-full self-center md:self-start mt-8">
        ...
        <div className=" h-auto flex flex-col md:flex-row justify-center items-center w-[80%]  space-x-12 mx-auto">
            ...
            <img src={Drone} alt="Artifice" className="object-cover md:max-w-[90%] lg:max-w-[80%] xl:max-w-[60%]"
            style={{borderRadius: "20px"}}></img>
            </div>
            ...
            <a href="/VoxUnityCharteGraphique" className="bg-white px-8 py-2 rounded-full self-center md:self-end mt-8">
            <h2 className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-text1 to-text2">
